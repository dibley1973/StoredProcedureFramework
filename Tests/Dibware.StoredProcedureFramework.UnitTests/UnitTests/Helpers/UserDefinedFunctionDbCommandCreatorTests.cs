...
{
    [TestClass]
    public class UserDefinedFunctionDbCommandCreatorTests
    {
        #region Fields
        ...
        {
            // ACT
            UserDefinedFunctionDbCommandCreator.CreateUserDefinedFunctionDbCommandCreator(null, FunctionName);
        }
        ...
        {
            // ACT
            UserDefinedFunctionDbCommandCreator.CreateUserDefinedFunctionDbCommandCreator(Connection, null);
        }
        ...
        {
            // ACT
            UserDefinedFunctionDbCommandCreator.CreateUserDefinedFunctionDbCommandCreator(Connection, string.Empty);
        }
        ...
        {
            // ARRANGE
            var builder = UserDefinedFunctionDbCommandCreator.CreateUserDefinedFunctionDbCommandCreator(Connection, FunctionName);
        ...
        {
            // ARRANGE
            string expectedCommandText = String.Format(UserDefinedFunctionDbCommandCreator.CommandTextFormat, FunctionName);
            var builder = UserDefinedFunctionDbCommandCreator.CreateUserDefinedFunctionDbCommandCreator(Connection, FunctionName);
