...
{
    [TestClass]
    public class SqlTableFunctionExecuterTests
    {
        #region Fields
        ...
        {
            // ACT
            SqlTableFunctionExecuter<TestResultSet>.CreateSqTablelFunctionExecuter(null, SqlFunctionName);
        }
        ...
        {
            // ACT
            SqlTableFunctionExecuter<TestResultSet>.CreateSqTablelFunctionExecuter(Connection, null);
        }
        ...
        {
            // ACT
            SqlTableFunctionExecuter<TestResultSet>.CreateSqTablelFunctionExecuter(Connection, string.Empty);
        }
        ...
        {
            // ACT
            var actualSqlFunctionExecuter = SqlTableFunctionExecuter<TestResultSet>.CreateSqTablelFunctionExecuter(Connection, SqlFunctionName);
