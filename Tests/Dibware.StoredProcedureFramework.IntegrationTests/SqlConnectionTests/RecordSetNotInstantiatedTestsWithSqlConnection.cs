...
namespace Dibware.StoredProcedureFramework.IntegrationTests.SqlConnectionTests
{
    ...
    public class RecordSetNotInstantiatedTestsWithSqlConnection : BaseSqlConnectionIntegrationTest
    {
        ...
        public void MultipleRecordSetStoredProcedure_WithOneRecordSetNotInsrtantiated_ThrowsException()
        {
            // ARRANGE
            ...
            var parameters = new MultipleRecordSetStoredProcedureWithNotInstantiatedRecordSet.Parameter
            {
                Id = expectedId,
                Name = expectedName,
            ...
            var procedure = new MultipleRecordSetStoredProcedureWithNotInstantiatedRecordSet(parameters);
