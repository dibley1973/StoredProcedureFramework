...
namespace Dibware.StoredProcedureFramework.Extensions
{
    ...
    //    private static void ReadFromStream(SqlDataReader reader, object t, String name, PropertyInfo p, StreamOutput stream)
    //    {
    ...
    //    /// <returns></returns>
    //    public static object ReadRecord(this SqlDataReader reader, object targetObject, PropertyInfo[] props)
    //    {
    //        string name = "";
