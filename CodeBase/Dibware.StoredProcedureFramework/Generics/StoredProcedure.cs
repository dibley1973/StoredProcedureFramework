...
namespace Dibware.StoredProcedureFramework.Generics
{
    ...
    //    : StoredProcedureBase<TReturn, object>
    //    where TReturn : class, new()
    //{
    //    protected AnonymousParameterProcedureBase(StoredProcedureContext context)
    //        : base(context)
    //    {
    ...
    //    : StoredProcedureBase<NullStoredProcedureResult, object>
    //{
    //    protected AnonymousParameterProcedureBase(StoredProcedureContext context)
    //        : base(context)
    //    {
    ...
    //    public StoredProcedure(StoredProcedureContext context, TParameters parameters)
    //        : base(parameters)
    //    {
